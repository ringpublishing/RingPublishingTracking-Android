...
fun RingPublishingTracking.reportShowOfferEvent(
    ...
    tpcc: String?,
) = reportEvent(paidEventsFactory.createShowOfferEvent(offerData, offerContextData, tpcc))
...
fun RingPublishingTracking.reportShowOfferTeaserEvent(
    ...
    offerContextData: OfferContextData,
    tpcc: String?,
) = reportEvent(paidEventsFactory.createShowOfferTeaserEvent(offerData, offerContextData, tpcc))
...
fun RingPublishingTracking.reportPurchaseClickButtonEvent(
    ...
    termId: String,
    tpcc: String?,
) = reportEvent(paidEventsFactory.createPurchaseClickButtonEvent(offerData, offerContextData, termId, tpcc))
...
fun RingPublishingTracking.reportPurchaseEvent(
    ...
    tpcc: String?,
    fakeUserId: String?
) = reportEvent(paidEventsFactory.createPurchaseEvent(offerData, offerContextData, subscriptionPaymentData, termId, termConversionId, tpcc, fakeUserId))
...
fun RingPublishingTracking.reportShowMetricLimitEvent(
    ...
    sourceDx: String,
) = reportEvent(paidEventsFactory.createShowMetricLimitEvent(supplierData, metricsData, sourcePublicationUuid, sourceDx))
...
fun RingPublishingTracking.reportLikelihoodScoringEvent(
    ...
    sourcePublicationUuid: String,
    sourceDx: String
) = reportEvent(paidEventsFactory.createLikelihoodScoringEvent(supplierData, likelihoodData, sourcePublicationUuid, sourceDx))
...
fun RingPublishingTracking.reportMobileAppFakeUserIdReplacedEvent(
    fakeUserId: String,
    realUserId: String
) = reportEvent(paidEventsFactory.createMobileAppFakeUserIdReplacedEvent(fakeUserId, realUserId))
