...
class DemoApplication : MultiDexApplication()
{
	...
	override fun onCreate()
	{
		...
		val tenantId = "EA-4178463" // <YOUR_TENANT_ID> todo: remove before publish to github
		val apiKey = "c43243ae5bdb4e6eabe0c59da9a67dda" // <YOUR_API_KEY>  todo: remove before publish to github
