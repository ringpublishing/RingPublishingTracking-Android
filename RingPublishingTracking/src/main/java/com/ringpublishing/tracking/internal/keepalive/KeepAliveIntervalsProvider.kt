...
internal class KeepAliveIntervalsProvider
{
	...
	fun nextIntervalForSendingMillis(timeFromStartInMillis: Long): Long
	{
		val delaySeconds = when (val timeInSeconds = timeFromStartInMillis / milliseconds)
		{
